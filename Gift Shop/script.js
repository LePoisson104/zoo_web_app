...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function buyButtonClicked() {
    ...
    for (var i = 0; i < cartBoxes.length; i++) {
      ...
      var totalPrice =
        parseFloat(priceElement.innerText.replace("$", "")) * quantity;

      // Create an object for the current item and add it to the checkout array
      var itemInfo = {
        itemName: itemName,
        quantity: quantity,
    ...
    // Clear the checkout array for the next transaction
    checkoutArray = [];
  }
